 ...
 */
export class PretextVisualEditorProvider implements vscode.CustomTextEditorProvider {

	public static register(context: vscode.ExtensionContext): vscode.Disposable {
		const provider = new PretextVisualEditorProvider(context);
		const providerRegistration = vscode.window.registerCustomEditorProvider(PretextVisualEditorProvider.viewType, provider);
